...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/service/HttpClient.ts":[function(require,module,exports) {
"use strict";
...
var HttpClient = function HttpClient(baseURL) {
  ...
  this._handleResponse = function (_ref) {
    var data = _ref.data;
    return data;
  };
...
},{"regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","axios":"node_modules/axios/index.js"}],"src/service/SearchService.ts":[function(require,module,exports) {
"use strict";
...
var _HttpClient2 = _interopRequireDefault(require("./HttpClient"));
...
var SEARCH_BASE_URL = "http://localhost:8080";

var SearchService = /*#__PURE__*/function (_HttpClient) {
  _inherits(SearchService, _HttpClient);
  ...
  function SearchService() {
    ...
    _this = _super.call(this, SEARCH_BASE_URL);

    _this.getSearchResults = function (searchTerm) {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return this.instance.get("/search/v1/term/" + searchTerm);
...
},{"./HttpClient":"src/service/HttpClient.ts"}],"src/model/SearchTypeEnum.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.SearchTypeEnum = void 0;
var SearchTypeEnum;
exports.SearchTypeEnum = SearchTypeEnum;

(function (SearchTypeEnum) {
  SearchTypeEnum["ONLINE_SHOP"] = "ONLINE_SHOP";
  SearchTypeEnum["BONUSES"] = "BONUSES";
...
exports.fetchSearchResultFromRestApi = fetchSearchResultFromRestApi;

var _SearchService = _interopRequireDefault(require("./service/SearchService"));

var _SearchTypeEnum = require("./model/SearchTypeEnum");
...
function fetchSearchResultFromRestApi() {
  return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var searchTerm, searchResults, resultPanelDiv, searchInputElement;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            searchTerm = document.getElementById('searchTermId').value;
          ...
          case 5:
            ...
            _context.prev = 6;
            _context.next = 9;
            return new _SearchService.default().getSearchResults(searchTerm);
          ...
          case 9:
            ...
            if (searchResults && searchResults.length > 0) {
              resultPanelDiv = document.getElementById("resultPanel");
              resultPanelDiv.style.display = "block";
              generateSearchAutoCompleteSuggestions(searchResults);
              searchInputElement = document.getElementById("searchTermId");
              searchInputElement.addEventListener("search", function (e) {
                clearSearchTextAndSearchResultDiv();
              });
          ...
          case 14:
            ...
            console.error("Some Error occurred while searching : ", _context.t0);
...
function generateSearchAutoCompleteSuggestions(searchResults) {
  var onlineShopDiv = document.getElementById("onlineShopContentDivId");
  var bonusesDiv = document.getElementById("pramienContentDivId");
  var gridContainerDiv = document.getElementById("gridContainerId");
  onlineShopDiv.textContent = '';
  bonusesDiv.textContent = '';
  var elements = document.getElementsByClassName("tileDiv");
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      if (result.searchTypeEnum === _SearchTypeEnum.SearchTypeEnum.ONLINE_SHOP) {
...
function generateGridLayout(searchResults, gridContainerDiv) {
  var divElement = document.createElement("div");
...
function createImageDiv(searchResults, outerDivElement) {
  var divElement = document.createElement("div");
...
function createHorizontalLine(outerDivElement) {
  var imgElement = document.createElement("hr");
  imgElement.setAttribute("style", "width: 95%; color: lightgray");
  outerDivElement.appendChild(imgElement);
}

function createTitleTextGrid(searchResults, outerDivElement) {
  var titleDivElement = document.createElement("div");
  titleDivElement.setAttribute("id", "tileTitleId" + searchResults.id);

  if (searchResults.searchTypeEnum === _SearchTypeEnum.SearchTypeEnum.BONUSES) {
  ...
  var tileTitleDivElement = document.createElement("div");
  ...
  var tileSubTitleDivElement = document.createElement("div");
...
function clearSearchTextAndSearchResultDiv() {
  var searchResultDivElement = document.getElementById("resultPanel");
  searchResultDivElement.style.display = 'none';
}
},{"./service/SearchService":"src/service/SearchService.ts","./model/SearchTypeEnum":"src/model/SearchTypeEnum.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], "customModule")
